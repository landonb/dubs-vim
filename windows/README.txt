...
Open a Windows command shell and change to the dubsvim
Windows installation directory

  E.g., F:\DubsVim\dubsvim\install\windows
...
the dubsvim configuration structure, and makes the
...
there's dubsvim.nsi and dubsvim-components.nsh,
which describe the actual dubsvim installer executable
that NSIS makes.
